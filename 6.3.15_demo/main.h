...
public:
	...
	void ReqQryTradingAccount()
	{
		...
		//int ab = m_pUserApi->ReqQryInvestor(&a, nRequestID++);
	...
	void ReqQryInvestUnit()
	{
		...
		//strcpy_s(a.InvestorID, g_chInvestorID);
		int b = 0;// m_pUserApi->ReqQryInvestUnit(&a, nRequestID++);
	...
	void ReqOptionSelfCloseInsert()
	{
		...
		strcpy_s(a.CurrencyID, "CNY");
		int b = 0;//m_pUserApi->ReqOptionSelfCloseInsert(&a, 1);
	...
	void ReqOptionSelfCloseAction()
	{
		...
		strcpy_s(a.UserID, g_chUserID);
		strcpy_s(a.InstrumentID, g_chInstrumentID);
		int b = 0;//m_pUserApi->ReqOptionSelfCloseAction(&a, 1);
	...
	void ReqQryOptionSelfClose()
	{
		...
		strcpy_s(a.InstrumentID, g_chInstrumentID);
		strcpy_s(a.ExchangeID, g_chExchangeID);
		int b = 0;//m_pUserApi->ReqQryOptionSelfClose(&a, 1);
	...
	void ReqQrySecAgentTradingAccount()
	{
		...
		strcpy_s(a.AccountID, g_chInvestorID);
		int b = 0;// m_pUserApi->ReqQrySecAgentTradingAccount(&a, 1);
	...
	void ReqQrySecAgentCheckMode()
	{
		...
		//strcpy_s(a.BrokerID, g_chBrokerID);
		//strcpy_s(a.InvestorID, g_chInvestorID);
		int b = 0;//m_pUserApi->ReqQrySecAgentCheckMode(&a, 1);
	...
	void ReqUserAuthMethod()
	{
		...
		//strcpy_s(a.BrokerID, g_chBrokerID);
		//strcpy_s(a.UserID, g_chUserID);
		int b = 0;//m_pUserApi->ReqUserAuthMethod(&a, nRequestID++);
	...
	void ReqGenUserCaptcha()
	{
		...
		//strcpy_s(a.BrokerID, g_chBrokerID);
		//strcpy_s(a.UserID, g_chUserID);
		int b = 0;//m_pUserApi->ReqGenUserCaptcha(&a, nRequestID++);
	...
	void ReqGenUserText()
	{
		...
		//strcpy_s(a.BrokerID, g_chBrokerID);
		//strcpy_s(a.UserID, g_chUserID);
		int b = 0;//m_pUserApi->ReqGenUserText(&a, nRequestID++);
	...
	void ReqUserLoginWithCaptcha()
	{
		...
		int b = 0;//m_pUserApi->ReqUserLoginWithCaptcha(&a, nRequestID++);
	...
	void ReqUserLoginWithText()
	{
		...
		int b = 0;//m_pUserApi->ReqUserLoginWithText(&a, nRequestID++);
	...
	void ReqUserLoginWithOTP()
	{
		...
		//a.ClientIPPort = 10000;
		int b = 0;//m_pUserApi->ReqUserLoginWithOTP(&a, nRequestID++);
	...
	void ReqQrySecAgentTradeInfo()
	{
		...
		int b = 0;//m_pUserApi->ReqQrySecAgentTradeInfo(&a, nRequestID++);
